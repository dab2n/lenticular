...
class LenticularCard {
  constructor(workspaceNode, onImageUpdate) {
    ...
    this.hint   = this.workspace.querySelector('.stage-hint'); this.shareBtn = this.workspace.querySelector('.share-trigger-btn');
...
/* ── Animated Share Modal Logic (with Motion Sensor) ── */
